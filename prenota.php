    ...
    <header>
        <nav>
            <ul>
                ...
                <li><a href="https://wa.me/+39 349 867 7859?text=Buongiorno,%20vorrei%20chiarire%20alcune%20informazioni">Contattaci</a></li>
            </ul>
        </nav>
    </header>
    <main>
        <section>
            ...
            <div class="booking-container">
                <div class="booking-form">
                    <form action="gestisciappuntamenti.php" method="post">
                        <p>Barbiere:</p>
